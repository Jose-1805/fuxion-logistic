...
<div class="row">
    ...
    <div class="col-xs-12 text-right margin-top-20">
        ...
        @if($estado->razon_estado == 'Pendiente por flete' || $demo)
            <a class="btn btn-primary" id="btn-entregado-tienda">Entregado en tienda</a>
        @endif
        <a class="btn btn-primary" id="btn-flete">Guardar</a>
    </div>
</div>
<div id="modal-aprobacion-flete" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
        ...
        <div class="modal-content" >
            ...
            <div class="modal-body row" id="">
                ...
                <div class="col-xs-12 text-right">
                    ...
                    <a class="btn btn-primary" id="btn-flete-ok">Aceptar</a>
                </div>
            </div>
        </div>
    </div>
