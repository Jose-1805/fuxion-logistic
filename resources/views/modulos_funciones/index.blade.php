        ...
        <div class="container white padding-50">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    @endif
                    <a class="btn btn-block btn-success btn-radius-sm" data-toggle="modal" @if($disabled == '') data-target="#modal-nuevo-modulo" @endif{{$disabled}}><i class="fa fa-plus margin-right-10"></i>Nuevo Módulo</a>
                    <a class="btn btn-block btn-success btn-radius-sm" data-toggle="modal" @if($disabled == '') data-target="#modal-nueva-funcion" @endif{{$disabled}}><i class="fa fa-plus margin-right-10"></i>Nueva Función</a>
                </div>
            </div>
        </div>
