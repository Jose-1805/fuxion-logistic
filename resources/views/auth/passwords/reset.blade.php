...
<div class="container">
    ...
    <div class="row" style="margin-top: 15%;">
        ...
        <div class="col-md-4">
            <p class="font-x-large text-center">Reestablecimiento de contraseña</p>
                ...
                <div class="form-group">
                    ...
                    <div class="">
                        ...
                        @if ($errors->has('password'))
                            <span class="help-block">
                                        <strong class="red-text text-lighten-2">{{ $errors->first('password') }}</strong>
                                    </span>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="">
                        ...
                        @if ($errors->has('password_confirmation'))
                            <span class="help-block">
                                        <strong class="red-text text-lighten-2">{{ $errors->first('password_confirmation') }}</strong>
                                    </span>
                        @endif
                    </div>
                </div>
