    ...
    <div class="container white padding-50">
        <div class="row">
            ...
            @else
                ...
                {!! Form::open(['id'=>'form-corte-pedidos','enctype'=>'multipart/form-data']) !!}
                ...
                <div class="col-xs-12 col-sm-4 col-md-3 margin-top-20">
                    <a href="#!" id="btn-guardar-corte" class="col-xs-12 btn btn-radius btn-success margin-top-5">Importar</a>
                </div>
                {!! Form::close() !!}
            @endif
        </div>
